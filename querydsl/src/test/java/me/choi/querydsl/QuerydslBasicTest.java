...
import me.choi.querydsl.dto.MemberDto;
import me.choi.querydsl.dto.QMemberDto;
import me.choi.querydsl.dto.UserDto;
...
//        List<Member> contents = queryResults.getResults();
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = entityManager.createQuery("select new me.choi.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
                                                .getResultList();
